...
```{r}
p = ggplot(prostate, aes(x=lpsa, y=Cscore)) + 
    geom_point(
        color="black",
        fill="#69b3a2",
        alpha=0.5,
...
p = ggplot(prostate, aes(x=lcavol, y=Cscore)) + 
    geom_point(
        color="black",
        fill="#69b3a2",
        alpha=0.5,
...
```{r}
p = ggplot(prostate, aes(x=Cscore)) + 
...
pdf(file="/home/james/Documents/KU-Leuven/first-year/Statistical-Methods-for-Bioinformatics/practical-one/coefficients-zoomed.pdf", width=9, height=6)
...
pdf(file="/home/james/Documents/KU-Leuven/first-year/Statistical-Methods-for-Bioinformatics/practical-one/coefficients.pdf", width=9, height=7)
...
pdf(file="/home/james/Documents/KU-Leuven/first-year/Statistical-Methods-for-Bioinformatics/practical-one/MSE.pdf", width=9, height=6)
...
```{r}
p = ggplot(normalised.df, aes(x=BNobject.x.t)) + 
geom_histogram(aes(y=..density..), bins=50, fill="#006dfc", color="#e9ecef", alpha=0.9)+
    geom_density(size=1, alpha=.3, color="#1c1b1b", fill="#006dfc")+
    xlim(-4,4)+
    ylim(0,0.6)+
