...
```{r}
plot(lcavol, Cscore, main="Regression lcavol vs Cscore", xlab="lcavol", ylab="Cscore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
abline(lm(Cscore~lcavol), data=prostate, col='red')

plot(lpsa, Cscore, main="Regression lpsa vs Cscore", xlab="lpsa", ylab="Csore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
abline(lm(Cscore~lpsa), data=prostate, col='red')

plot(lweight, Cscore, main="Regression lweight vs Cscore", xlab="lweight", ylab="Csore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
abline(lm(Cscore~lweight), data=prostate, col='red')

plot(lbph, Cscore, main="Regression lbph vs Cscore", xlab="lbph", ylab="Csore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
abline(lm(Cscore~lbph), data=prostate, col='red')

plot(age, Cscore, main="Regression age vs Cscore", xlab="age", ylab="Csore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
abline(lm(Cscore~age), data=prostate, col='red')

plot(lcp, Cscore, main="Regression lcp vs Cscore", xlab="lcp", ylab="Csore", cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
...
```{r}
hist(y, prob=TRUE, main='Density plot for Cscore', breaks=50, col='grey', xlim=c(-50,250), ylim = c(0, 0.025), xlab='Cscore', cex.main=1.4, cex.lab=1.3, cex.axis=1.1)
...
plot(lasso.mod, xvar="lambda", lwd=2, col = brewer.pal(n = 7, name = "Dark2"), xlim=c(0.5,3.5), ylim=c(-12,15), cex.lab=1.3, cex.axis=1.1)
...
plot(lasso.mod, xvar="lambda", lwd=2, col = brewer.pal(n = 7, name = "Dark2"), cex.lab=1.3, cex.axis=1.1)
...
plot(cv.out, cex.lab=1.3, cex.axis=1.1)
...
hist(BNobject$x.t, prob=TRUE, main='Density plot for normalised Cscore', breaks=50, col='grey', xlim=c(-4,4), ylim=c(0,0.5), xlab='Cscore', cex.lab=1.3, cex.axis=1.1, cex.main=1.2)
...
plot(lcavol, Cscore, xlim=lcavol.lims, cex =.5, col="darkgrey", cex.lab=1.3, cex.axis=1.1)
...
plot(lpsa, Cscore, xlim=lpsa.lims, cex =.5, col="darkgrey", cex.lab=1.3, cex.axis=1.1)
